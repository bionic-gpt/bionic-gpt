...
use web_pages::routes::web_search::{ConfigureApiKey, DeleteApiKey, Index, Select};
...
pub async fn loader(
    ...
    let html = web_pages::web_search::page::page(team_id, rbac, summaries, selected_spec_id);
...
pub async fn configure_api_key_action(
    ...
    if spec.category != OpenapiSpecCategory::WebSearch {
        return Err(CustomError::Authorization);
    }

...
GRANT SELECT, INSERT, UPDATE, DELETE ON chats, conversations TO application_user;
GRANT USAGE, SELECT ON chats_id_seq, conversations_id_seq TO application_user;

-- Give access to the readonly user
GRANT SELECT ON chats, conversations TO application_readonly;
GRANT SELECT ON chats_id_seq, conversations_id_seq TO application_readonly;

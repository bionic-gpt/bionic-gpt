...
GRANT SELECT, INSERT ON team_users TO application_user;
GRANT SELECT, INSERT, UPDATE ON teams TO application_user;
GRANT SELECT, INSERT, DELETE ON invitations TO application_user;
GRANT USAGE, SELECT ON invitations_id_seq, teams_id_seq TO application_user;

-- Give access to the readonly user
GRANT SELECT ON invitations, teams, team_users TO application_readonly;
GRANT SELECT ON invitations_id_seq, teams_id_seq TO application_readonly;

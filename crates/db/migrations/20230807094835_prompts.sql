...
GRANT SELECT, INSERT, UPDATE, DELETE ON prompts TO application_user;
GRANT USAGE, SELECT ON prompts_id_seq TO application_user;
GRANT SELECT, INSERT, UPDATE, DELETE ON prompt_dataset TO application_user;

-- Give access to the readonly user
GRANT SELECT ON prompts TO application_readonly;
GRANT SELECT ON prompts_id_seq TO application_readonly;
GRANT SELECT ON prompt_dataset TO application_readonly;

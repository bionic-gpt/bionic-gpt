...
-- Grant access
GRANT SELECT, INSERT ON audit_trail, audit_trail_text_generation TO application_user;
GRANT USAGE, SELECT ON audit_trail_id_seq, audit_trail_text_generation_id_seq TO application_user;

GRANT SELECT ON audit_trail, audit_trail_text_generation TO application_readonly;
GRANT SELECT ON audit_trail_id_seq, audit_trail_text_generation_id_seq TO application_readonly;

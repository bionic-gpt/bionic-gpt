...
-- Grant access
GRANT SELECT, INSERT ON audit_trail TO ft_application;
GRANT USAGE, SELECT ON audit_trail_id_seq TO ft_application;

GRANT SELECT ON audit_trail TO ft_readonly;
GRANT SELECT ON audit_trail_id_seq TO ft_readonly;

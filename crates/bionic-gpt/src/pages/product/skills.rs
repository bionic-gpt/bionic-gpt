    ...
    let page = rsx! {
        Layout {
            ...
            div {
                ...
                ImageFeature {
                    title: "Give AI teams reusable domain skills".to_string(),
                    sub_title: "Package instructions, templates, and workflows that appear directly inside the sandbox runtime".to_string(),
                    image: "/product/skills.png"
                }

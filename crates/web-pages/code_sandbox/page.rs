                ...
                div {
                        ...
                        action: Some(rsx!(
                            div {
                                ...
                                if summary.has_api_key && summary.has_key_configured {
                                    form {
                                        method: "post",
                                        action: crate::routes::code_sandbox::Select { team_id: team_id.clone(), id: spec.id }.to_string(),
                                        Button {
                                    ...
                                    form {
                                        method: "post",
                                        action: crate::routes::code_sandbox::DeleteApiKey { team_id: team_id.clone(), id: spec.id }.to_string(),
                                        Button {
                                            button_type: ButtonType::Submit,
                    ...
                    if summary.has_api_key {
                        OpenapiSpecApiKeyForm {
                            ...
                            action: crate::routes::code_sandbox::ConfigureApiKey { team_id: team_id.clone(), id: spec.id }.to_string(),

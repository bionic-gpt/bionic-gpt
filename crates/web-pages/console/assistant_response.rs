...
#[component]
pub fn AssistantResponse(response: String, is_tts_disabled: bool) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: "response-formatter prose prose-sm sm:prose-base max-w-none break-words",
            ...
            div {
                class: "mt-2 flex items-center gap-2 text-base-content/60",
                if !is_tts_disabled {
                    ToolTip {
                        text: "Read aloud",
                        img {

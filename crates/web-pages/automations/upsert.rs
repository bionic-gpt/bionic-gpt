    ...
    let page = rsx! {
        AdminLayout {
            ...
            header: rsx!(
                ...
                h3 {
                    if prompt.id.is_some() { "Edit Automation" } else { "Create Automation" }
                }
            ),
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    div {
                                        ...
                                        Fieldset {
                                            legend: "Category",
                                            help_text: "Categories help users find automations.",
                                            Select {
                                                name: "category_id",
                                    ...
                                    div {
                                        ...
                                        Fieldset {
                                            legend: "Visibility",
                                            help_text: "Set to private if you don't want to share this automation.",
                                            Select {
                                                name: "visibility",
                                ...
                                div {
                                    ...
                                    TextArea {
                                        ...
                                        rows: "3",
                                        label: "Description",
                                        help_text: "Describe what this automation does and how it can help users.",
                                        required: true,
                                        "{prompt.description}",
                                    }
                                }
                    ...
                    Card {
                        ...
                        CardBody {
                            ...
                            TextArea {
                                ...
                                name: "system_prompt",
                                rows: "16",
                                help_text: "Define the automation's behavior, personality, and capabilities.",
                                "{prompt.system_prompt}",
                            }
                        }
                    }

                    // Automation Icon Section
                    Card {
                        class: "mb-6",
                        CardHeader {
                        ...
                        CardBody {
                            div {
                                label {
                                    ...
                                    "Upload Automation Icon"
                                }
                                p {
                                    class: "text-sm text-gray-500 mb-3",
                                    "Choose an image that represents your automation. Recommended size: 48x48 pixels."
                                }
                                FileInput {
                                    name: "image_icon",
                                    accept: "image/*",
                        ...
                        CardBody {
                            div {
                                ...
                                Button {
                                    ...
                                    if prompt.id.is_some() { "Update Automation" } else { "Create Automation" }
                                }
                            }
                        }
                    }

#!/bin/bash 
containers=("ghcr.io/bionic-gpt/bionicgpt" "ghcr.io/bionic-gpt/bionicgpt-embeddings-job" "ghcr.io/bionic-gpt/bionicgpt-envoy" "ghcr.io/bionic-gpt/bionicgpt-db-migrations")

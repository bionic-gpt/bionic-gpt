...
services:
  ...
  envoy:
    image: ghcr.io/purton-tech/bionicgpt-envoy:1.1.4
    ports:
      - "7800:7700"
  ...
  migrations:
    image: ghcr.io/purton-tech/bionicgpt-db-migrations:1.1.4
    environment:
  ...
  embeddings-job:
    image: ghcr.io/purton-tech/bionicgpt-embeddings-job:1.1.4
    environment:
  ...
  # Our axum server delivering our user interface
  app:
    image: ghcr.io/purton-tech/bionicgpt:1.1.4
    environment:
      APP_DATABASE_URL: postgresql://ft_application:testpassword@db:5432/postgres?sslmode=disable
    depends_on:
      db:
